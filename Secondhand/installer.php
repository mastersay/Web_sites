...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221024_secondhand_ea803f1de0b0a8039936_20221028085810_archive.zip';
        const ARCHIVE_SIZE       = '89337476';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'ea803f1-28085810';
        const SECONDARY_PACKAGE_HASH = '79d8875-28085810';
        const VERSION            = '1.5.0';
