...
<header id="header">
    <div class="d-flex flex-column">
        ...
        <div class="profile">
            <a href="log_out.php" class="bi bi-box-arrow-left mt-3 fs-3" title="Log out"></a>
            <img src="assets/img/profile-img.jpg" alt="" class="img-fluid rounded-circle">
            <h1 class="text-light"><a href="index.php">Name Surname</a></h1>
                        ...
                        <div class="col-lg-6">
                            <ul>
                                <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong>
                                    <span>1 January 2000</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong>
                                    <span>www.example.com</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong>
                                    <span>+421 911 222 333</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>City:</strong>
                                    <span>City, State</span></li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <ul>
        ...
        <div class="container">
            ...
            <div class="row skills-content">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="progress">
                        <span class="skill">C/C++ <i class="val">45%</i></span>
                        <div class="progress-bar-wrap">
                    ...
                    <div class="progress">
                        <span class="skill">VBA <i class="val">25%</i></span>
                        <div class="progress-bar-wrap">
                ...
                <div class="col-lg-5 d-flex align-items-stretch">
                    <div class="info">
                        <div class="address">
                            ...
                            <h4>Location:</h4>
                            <p>Komenského 1107, 024 01 Kysucké Nové Mesto</p>
                        </div>
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5091.684986383412!2d18.789255438012393!3d49.3031339992294!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4714434cc795f2c5%3A0x382a67dba9c15cce!2zU3BvamVuw6EgUHJpZW15c2VsbsOhIMWga29sYSBLTk0!5e0!3m2!1sen!2ssk!4v1655565614898!5m2!1sen!2ssk"
